...
import 'package:cbj_smart_device/features/smart_device/domain/entities/set_devices_e/set_devices_e.dart';
...
//  TODO: Pull the saved devices into the app variables
  ...
  Future<void> setAllDevices({List<SmartDeviceBaseAbstract>? deviceList}) async {
    if (deviceList != null) {
