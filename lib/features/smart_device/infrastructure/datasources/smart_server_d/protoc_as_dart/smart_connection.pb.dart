...
class ClientStatusRequests extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<AllRemoteCommands>(
        41,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'allRemoteCommands',
        protoName: 'allRemoteCommands',
        subBuilder: AllRemoteCommands.create)
  ...
  ClientStatusRequests copyWith(void Function(ClientStatusRequests) updates) =>
      super.copyWith((message) => updates(message as ClientStatusRequests))
          as ClientStatusRequests; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(41)
  set allRemoteCommands(AllRemoteCommands v) {
    setField(41, v);
  }
...
class RequestsAndStatusFromHub extends $pb.GeneratedMessage {
  ...
  RequestsAndStatusFromHub copyWith(
      ...
      super.copyWith((message) => updates(message as RequestsAndStatusFromHub))
          as RequestsAndStatusFromHub; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AllRemoteCommands extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<SmartDeviceInfo>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'smartDeviceInfo',
        protoName: 'smartDeviceInfo',
        subBuilder: SmartDeviceInfo.create)
    ..hasRequiredFields = false;
  ...
  AllRemoteCommands copyWith(void Function(AllRemoteCommands) updates) =>
      super.copyWith((message) => updates(message as AllRemoteCommands))
          as AllRemoteCommands; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(40)
  set smartDeviceInfo(SmartDeviceInfo v) {
    setField(40, v);
  }
...
class FirstSetupMessage extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<CompInfo>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'compInfo',
        protoName: 'compInfo',
        subBuilder: CompInfo.create)
    ..aOM<FirebaseAccountInformation>(
        39,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'firebaseAccountInformation',
        protoName: 'firebaseAccountInformation',
        subBuilder: FirebaseAccountInformation.create)
    ..hasRequiredFields = false;
  ...
  FirstSetupMessage copyWith(void Function(FirstSetupMessage) updates) =>
      super.copyWith((message) => updates(message as FirstSetupMessage))
          as FirstSetupMessage; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(39)
  set firebaseAccountInformation(FirebaseAccountInformation v) {
    setField(39, v);
  }
...
class CompInfo extends $pb.GeneratedMessage {
  ...
  factory CompInfo.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory CompInfo.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  CompInfo copyWith(void Function(CompInfo) updates) =>
      super.copyWith((message) => updates(message as CompInfo))
          as CompInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static CompInfo getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<CompInfo>(create);
  static CompInfo? _defaultInstance;

  @$pb.TagNumber(21)
  CompSpecs get compSpecs => $_getN(0);
  @$pb.TagNumber(21)
  set compSpecs(CompSpecs v) {
    setField(21, v);
  }
...
class CompSpecs extends $pb.GeneratedMessage {
  ...
  factory CompSpecs.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory CompSpecs.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  CompSpecs copyWith(void Function(CompSpecs) updates) =>
      super.copyWith((message) => updates(message as CompSpecs))
          as CompSpecs; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static CompSpecs getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<CompSpecs>(create);
...
class MicrocontrollerSpecs extends $pb.GeneratedMessage {
  ...
  MicrocontrollerSpecs copyWith(void Function(MicrocontrollerSpecs) updates) =>
      super.copyWith((message) => updates(message as MicrocontrollerSpecs))
          as MicrocontrollerSpecs; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SmartDeviceInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOS(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'stateMassage',
        protoName: 'stateMassage')
    ..aOB(
        29,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'isComputer',
        protoName: 'isComputer')
    ..aOM<CompSpecs>(
        30,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  factory SmartDeviceInfo.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory SmartDeviceInfo.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  SmartDeviceInfo copyWith(void Function(SmartDeviceInfo) updates) =>
      super.copyWith((message) => updates(message as SmartDeviceInfo))
          as SmartDeviceInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static SmartDeviceInfo create() => SmartDeviceInfo._();
  SmartDeviceInfo createEmptyInstance() => create();
  static $pb.PbList<SmartDeviceInfo> createRepeated() =>
      $pb.PbList<SmartDeviceInfo>();
  @$core.pragma('dart2js:noInline')
  static SmartDeviceInfo getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<SmartDeviceInfo>(create);
  ...
  @$pb.TagNumber(34)
  set deviceTypesActions(DeviceTypesActions v) {
    setField(34, v);
  }
...
class SmartDeviceStatus extends $pb.GeneratedMessage {
  ...
  SmartDeviceStatus copyWith(void Function(SmartDeviceStatus) updates) =>
      super.copyWith((message) => updates(message as SmartDeviceStatus))
          as SmartDeviceStatus; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class CommendStatus extends $pb.GeneratedMessage {
  ...
  CommendStatus copyWith(void Function(CommendStatus) updates) =>
      super.copyWith((message) => updates(message as CommendStatus))
          as CommendStatus; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SmartDeviceUpdateDetails extends $pb.GeneratedMessage {
  ...
  SmartDeviceUpdateDetails copyWith(
      ...
      super.copyWith((message) => updates(message as SmartDeviceUpdateDetails))
          as SmartDeviceUpdateDetails; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(6)
  set smartDevice(SmartDeviceInfo v) {
    setField(6, v);
  }
...
class FirebaseAccountInformation extends $pb.GeneratedMessage {
  ...
  FirebaseAccountInformation clone() =>
      FirebaseAccountInformation()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  FirebaseAccountInformation copyWith(
      ...
      super.copyWith(
              (message) => updates(message as FirebaseAccountInformation))
          as FirebaseAccountInformation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class DeviceTypesActions extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..e<DeviceTypes>(
        ...
        defaultOrMaker: DeviceTypes.typeNotSupported,
        valueOf: DeviceTypes.valueOf,
        enumValues: DeviceTypes.values)
    ..e<DeviceActions>(
        36,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
        ...
        defaultOrMaker: DeviceActions.actionNotSupported,
        valueOf: DeviceActions.valueOf,
        enumValues: DeviceActions.values)
    ..e<DeviceStateGRPC>(
        37,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
        ...
        defaultOrMaker: DeviceStateGRPC.stateNotSupported,
        valueOf: DeviceStateGRPC.valueOf,
        enumValues: DeviceStateGRPC.values)
    ..hasRequiredFields = false;
  ...
  factory DeviceTypesActions.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory DeviceTypesActions.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  DeviceTypesActions copyWith(void Function(DeviceTypesActions) updates) =>
      super.copyWith((message) => updates(message as DeviceTypesActions))
          as DeviceTypesActions; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static DeviceTypesActions create() => DeviceTypesActions._();
  DeviceTypesActions createEmptyInstance() => create();
  static $pb.PbList<DeviceTypesActions> createRepeated() =>
      $pb.PbList<DeviceTypesActions>();
  @$core.pragma('dart2js:noInline')
  static DeviceTypesActions getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<DeviceTypesActions>(create);
  static DeviceTypesActions? _defaultInstance;

  @$pb.TagNumber(35)
  DeviceTypes get deviceType => $_getN(0);
  @$pb.TagNumber(35)
  set deviceType(DeviceTypes v) {
    setField(35, v);
  }
  ...
  @$pb.TagNumber(36)
  set deviceAction(DeviceActions v) {
    setField(36, v);
  }
  ...
  @$pb.TagNumber(37)
  set deviceStateGRPC(DeviceStateGRPC v) {
    setField(37, v);
  }
