...
final $typed_data.Uint8List deviceTypesDescriptor = $convert.base64Decode(
    'CgtEZXZpY2VUeXBlcxIUChB0eXBlTm90U3VwcG9ydGVkEAASCQoFbGlnaHQQARIKCgZibGluZHMQAhIKCgZib2lsZXIQAxIKCgZidXR0b24QBBITCg9idXR0b25XaXRoTGlnaHQQBRIHCgNodWIQBxIMCghwaG9uZUFwcBAIEg8KC2NvbXB1dGVyQXBwEAkSDgoKYnJvd3NlckFwcBAK');
...
final $typed_data.Uint8List deviceActionsDescriptor = $convert.base64Decode(
    'Cg1EZXZpY2VBY3Rpb25zEhYKEmFjdGlvbk5vdFN1cHBvcnRlZBAAEgYKAm9uEAESBwoDb2ZmEAISCgoGbW92ZVVwEAMSCAoEc3RvcBAEEgwKCG1vdmVEb3duEAUSCwoHcHJlc3NlZBAGEg0KCWxvbmdQcmVzcxAHEg0KCWRvdWJsZVRhcBAI');
...
final $typed_data.Uint8List whenToExecuteDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List deviceStateGRPCDescriptor = $convert.base64Decode(
    'Cg9EZXZpY2VTdGF0ZUdSUEMSFQoRc3RhdGVOb3RTdXBwb3J0ZWQQABIYChRjYW5jZWxTdGF0ZUluUHJvY2VzcxABEgcKA2FjaxACEhIKDm5ld1N0YXRlRmFpbGVkEAMSEQoNd2FpdGluZ0luQ29tcBAE');
...
const ClientStatusRequests$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.SmartConnection.AllRemoteCommands',
...
final $typed_data.Uint8List clientStatusRequestsDescriptor = $convert.base64Decode(
    'ChRDbGllbnRTdGF0dXNSZXF1ZXN0cxJQChFhbGxSZW1vdGVDb21tYW5kcxgpIAEoCzIiLlNtYXJ0Q29ubmVjdGlvbi5BbGxSZW1vdGVDb21tYW5kc1IRYWxsUmVtb3RlQ29tbWFuZHM=');
...
final $typed_data.Uint8List requestsAndStatusFromHubDescriptor =
    $convert.base64Decode(
        'ChhSZXF1ZXN0c0FuZFN0YXR1c0Zyb21IdWISUAoRYWxsUmVtb3RlQ29tbWFuZHMYKiABKAsyIi5TbWFydENvbm5lY3Rpb24uQWxsUmVtb3RlQ29tbWFuZHNSEWFsbFJlbW90ZUNvbW1hbmRz');
...
const AllRemoteCommands$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.SmartConnection.SmartDeviceInfo',
      '10': 'smartDeviceInfo'
    },
  ],
};
...
final $typed_data.Uint8List allRemoteCommandsDescriptor = $convert.base64Decode(
    'ChFBbGxSZW1vdGVDb21tYW5kcxJKCg9zbWFydERldmljZUluZm8YKCABKAsyIC5TbWFydENvbm5lY3Rpb24uU21hcnREZXZpY2VJbmZvUg9zbWFydERldmljZUluZm8=');
...
const FirstSetupMessage$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.SmartConnection.FirebaseAccountInformation',
...
final $typed_data.Uint8List firstSetupMessageDescriptor = $convert.base64Decode(
    'ChFGaXJzdFNldHVwTWVzc2FnZRI1Cghjb21wSW5mbxgmIAEoCzIZLlNtYXJ0Q29ubmVjdGlvbi5Db21wSW5mb1IIY29tcEluZm8SawoaZmlyZWJhc2VBY2NvdW50SW5mb3JtYXRpb24YJyABKAsyKy5TbWFydENvbm5lY3Rpb24uRmlyZWJhc2VBY2NvdW50SW5mb3JtYXRpb25SGmZpcmViYXNlQWNjb3VudEluZm9ybWF0aW9u');
...
final $typed_data.Uint8List compInfoDescriptor = $convert.base64Decode(
    'CghDb21wSW5mbxI4Cgljb21wU3BlY3MYFSABKAsyGi5TbWFydENvbm5lY3Rpb24uQ29tcFNwZWNzUgljb21wU3BlY3MSUAoSc21hcnREZXZpY2VzSW5Db21wGBwgAygLMiAuU21hcnRDb25uZWN0aW9uLlNtYXJ0RGV2aWNlSW5mb1ISc21hcnREZXZpY2VzSW5Db21w');
...
final $typed_data.Uint8List compSpecsDescriptor = $convert.base64Decode(
    '');
...
const SmartDeviceInfo$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.SmartConnection.MicrocontrollerSpecs',
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.SmartConnection.DeviceTypesActions',
...
final $typed_data.Uint8List smartDeviceInfoDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List smartDeviceStatusDescriptor = $convert.base64Decode(
    'ChFTbWFydERldmljZVN0YXR1cxIeCgpvbk9mZlN0YXRlGAQgASgIUgpvbk9mZlN0YXRl');
...
const DeviceTypesActions$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.SmartConnection.DeviceActions',
      '10': 'deviceAction'
    },
    const {
      '1': 'deviceStateGRPC',
      ...
      '4': 1,
      '5': 14,
      '6': '.SmartConnection.DeviceStateGRPC',
      '10': 'deviceStateGRPC'
    },
  ],
};
